/*
  ...
  - The values [WAITING_FOR_RETURN] on the enum `MeetingStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
ALTER TYPE "LoanStatus" ADD VALUE 'MEETING';

-- AlterEnum
BEGIN;
CREATE TYPE "MeetingStatus_new" AS ENUM ('PENDING', 'ACCEPTED', 'REJECTED', 'COMPLETED');
